...
android {
    namespace = "com.example.spendmgr"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.spendmgr"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
        ...
        // local.properties の値を BuildConfig に注入する
        // 実際の値は local.properties の google.web.client.id に設定すること
        buildConfigField(
            "String",
...
dependencies {
    // Core Library Desugaring (for java.time on API < 26, though minSdk=26 covers it)
